    ...
    <footer className="bg-gray-50 border-t">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-600 tracking-wider uppercase">For Vendors</h3>
            <ul className="mt-4 space-y-4">
              <li>
                <Link to="/vendor/register" className="text-base text-gray-500 hover:text-gray-900">
                  Register Your Shop
                </Link>
              </li>
              <li>
                <Link to="/vendor/pricing" className="text-base text-gray-500 hover:text-gray-900">
                  Pricing Plans
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 text-center">
            © {new Date().getFullYear()} EveryDayNeed. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
